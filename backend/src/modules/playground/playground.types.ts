...
/** A file in the skill's virtual directory (SKILL.md, reference.md, scripts/helper.py, etc.) */
export interface SkillFile {
  path: string;
  content: string;
}

/** Map of relative path -> file content for the virtual skill directory */
...
export interface CreatePlaygroundSessionInput {
  skillCatalogId?: string;
  skillMdContent: string;
  config?: Partial<PlaygroundSessionConfig>;
  agentId?: string;
